...
#  Choices: any of ['sha512', 'sha224', 'md5', 'blake2b', 'sha256', 'sha3_512', 'sha3_384', 'sha3_256', 'sha3_224', 'sha384', 'sha1', 'blake2s']
#  Default: 'sha256'
...
#------------------------------------------------------------------------------
## Th filesystem path to SQLite Database file (e.g.
...
c.FileCheckpoints.checkpoint_dir='/opt/apps'
